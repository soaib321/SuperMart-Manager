...
public class UserManagement extends javax.swing.JFrame {
    ...
    public UserManagement() {
        ...
        userscroll.setViewportView(userTable);  // Correctly attach JTable to JScrollPane
...
//    }
    ...
    try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Hp\\IdeaProjects\\SuperMarket\\src\\spa\\users.txt"))) {
        ...
        while ((line = br.readLine()) != null) {
            ...
            String[] parts = line.split(","); // Assuming CSV format: username,password,role,status
            if (parts.length == 4) {
                tableModel.addRow(new Object[]{parts[0], parts[2], parts[3]}); // Exclude password for security
            }
        }
    } catch (IOException e) {
    ...
    private void updateUser() {
        ...
        if (selectedRow != -1) {
            ...
            users.saveUsersToFile("C:\\Users\\Hp\\IdeaProjects\\SuperMarket\\src\\spa\\users.txt"); // Add the text file using path
